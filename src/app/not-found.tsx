  ...
  return (
    <div style={{ minHeight: '100vh', display: 'flex', alignItems: 'center', justifyContent: 'center', background: '#F3F3EB', fontFamily: "'DM Sans', sans-serif" }}>
      <div style={{ textAlign: 'center' }}>
        ...
        <Link href="/" style={{ display: 'inline-flex', marginTop: 24, padding: '10px 24px', background: '#CB3817', color: 'white', borderRadius: 8, fontSize: 13, fontWeight: 600, textDecoration: 'none' }}>
          Volver al inicio
        </Link>
      </div>
    </div>
