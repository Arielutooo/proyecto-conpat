        ...
        <div>
          <div style={{ display: 'flex', alignItems: 'center', gap: 12, marginBottom: 64 }}>
            <div style={{ background: 'oklch(0.55 0.18 245)', borderRadius: 10, width: 40, height: 40, display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
              <Icon name="briefcase" size={18} style={{ color: 'white' }} />
            </div>
            <div>
        ...
        <div style={{ width: '100%', maxWidth: 380 }}>
          ...
          {!role && (
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 12, marginBottom: 28 }}>
              {[
                { id: 'admin' as Role, label: 'Administrador', sub: 'Gestor Patrimonial', icon: 'building', color: 'oklch(0.55 0.18 245)' },
                { id: 'cfo_externo' as Role, label: 'CFO Externo', sub: 'Acceso de lectura', icon: 'briefcase', color: 'oklch(0.55 0.18 145)' },
              ].map(r => (
                <button
                  key={r.id}
